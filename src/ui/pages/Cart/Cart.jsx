...
import { resetCart } from "../../../redux/orbiSlice";
    ...
    <div className="max-w-container mx-auto px-4">
      ...
      {products.length > 0 ? (
        <div className="pb-20">
          ...
          <button onClick={() => dispatch(resetCart())} className="py-2 px-10 bg-red-500 text-white font-semibold uppercase mb-4 hover:bg-red-700 duration-300">
            Reset cart
          </button>
