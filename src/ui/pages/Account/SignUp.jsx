              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-start mdl:items-center gap-2">
                  ...
                  <p className="text-sm text-primeColor">
                    I agree to the OREBI <span className="text-blue-500">Terms of Service </span>and <span className="text-blue-500">Privacy Policy</span>.
                  </p>
                </div>
                <button
                  onClick={handleSignUp}
                  className={`${
                    checked ? "bg-primeColor hover:bg-black hover:text-white cursor-pointer" : "bg-gray-500 hover:bg-gray-500 hover:text-gray-200 cursor-none"
