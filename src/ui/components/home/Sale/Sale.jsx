    ...
    <div className="py-20 flex flex-col md:flex-row items-center justify-between gap-4 lg:gap-10">
      <div className="bg-[#f3f3f3] w-full md:w-2/3 lg:w-1/2 h-full flex flex-col justify-center items-center text-black">
        ...
        <div className="text-left h-140 md:h-200 lg:h-260 w-full mx-4 ">
          <div className="mx-8">
            <h2 className="text-4xl md:text-5xl lg:text-5xl font-bold mb-6">Imprimante sales</h2>
            <p className="text-lg md:text-xl lg:text-2xl mb-6">
              Up to <span className="text-4xl md:text-5xl lg:text-5xl font-bold">30%</span> sales for all impriamnte{" "}
            </p>
            <div className=" mb-8">
              <ShopNow />
            </div>
